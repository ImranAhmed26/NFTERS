...
const Navbar = () => {
  ...
  return (
    <div className="bg-white lg:border-b flex justify-center mb-10 lg:mb-0">
      <div className="flex items-center flex-col lg:flex-row h-28 py-3.5 text-lg sticky z-30 top-0">
        ...
        <div className="flex flex-col md:flex-row lg:items-center lg:w-1/2 gap-4 ">
          <div
            className="border min-w-[300px] max-w-lg w-full h-[50px] rounded-full px-4 text-xl items-center flex justify-between shadow-sm"
            onClick={(e) => {
              handleSearch;
            }}
          >
